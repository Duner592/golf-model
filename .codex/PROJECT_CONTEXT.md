...
- `archive-update.yml` refreshes actual results with `--allow-missing` and rebuilds prediction accuracy after previous-week archive updates, then commits `web/archive/**` and `data/analytics/**` changes.
